...
const (
	Occupation_UNSPECIFIED Occupation = 0
	Occupation_DEVELOPER   Occupation = 1
...
const file_proto_employee_proto_rawDesc = "" +
	"\n" +
	"\x14proto/employee.proto\x12\bemployee\x1a\x10proto/date.proto\"\xaa\x03\n" +
	"\bEmployee\x12\x0e\n" +
...
var file_proto_employee_proto_depIdxs = []int32{
	...
	7, // 3: employee.Employee.birth_date:type_name -> date.Date
